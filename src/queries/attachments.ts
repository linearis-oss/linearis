/**
 * GraphQL query strings for attachment operations
 *
...
// Load the attachments files once at module initialization
const attachmentsQueriesGraphQL = readFileSync(
  join(__dirname, "../../graphql/queries/attachments.graphql"),
  "utf-8"
);
const attachmentsMutationsGraphQL = readFileSync(
  join(__dirname, "../../graphql/mutations/attachments.graphql"),
  "utf-8"
);

// Combine both files for extraction
const attachmentsGraphQL = attachmentsQueriesGraphQL + "\n\n" + attachmentsMutationsGraphQL;
...
export const LIST_ATTACHMENTS_QUERY = extractOperation(attachmentsGraphQL, "ListAttachments");
export const CREATE_ATTACHMENT_MUTATION = extractOperation(attachmentsGraphQL, "AttachmentCreate");
export const DELETE_ATTACHMENT_MUTATION = extractOperation(attachmentsGraphQL, "AttachmentDelete");
