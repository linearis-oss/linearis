...
## Query Type Re-exports (`src/queries/`)

Convenience re-exports of types from the generated code, grouped by domain.

- **issues.ts** -- Issue query type re-exports
- **documents.ts** -- Document query type re-exports
- **attachments.ts** -- Attachment query type re-exports
- **project-milestones.ts** -- Milestone query type re-exports
